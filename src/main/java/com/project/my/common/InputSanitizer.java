...
public class InputSanitizer {
    ...
    // 지역번호, 휴대폰, 지능망 번호 등 한국 패턴에 맞춰 XXX-XXXX-XXXX 등으로 포맷 변환
    ...
    //전화번호 등에서 숫자만 남김 (010-1234-5678 → 01012345678)
    ...
    // LocalDateTime에서 날짜 부분("yyyy-MM-dd")만 추출
